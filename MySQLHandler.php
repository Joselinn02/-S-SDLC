...
if (!defined('_SITE_ROOT')){define('SITE_ROOT', dirname(dirname(FILE_)));}

/* Read database configuration file and populate class parameters */
require_once _SITE_ROOT_.'/includes/database-config.inc';
